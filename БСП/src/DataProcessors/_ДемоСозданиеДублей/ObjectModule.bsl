...
Процедура СоздатьДублиИспользующиесяВРегистрахНакопления(Настройки, Результат)
	...
	//   2 вида измерений:
	//     * Регистратор (ДокументСсылка.ПоступлениеТоваров).
	//     * Организация (СправочникСсылка._ДемоОрганизации).
	//     По измерениям тестируется 3 вида пересечения данных:
	//       - есть запись по дублю, но нет записи по оригиналу
	//       - есть запись по оригиналу, но нет записи по дублю
	//       - есть обе записи.
	//     Однако, поскольку Организация указывается в шапке документа ПоступлениеТоваров,
	...
	//   Под каждый вариант нужно создать 12 документов ПоступлениеТоваров.
	...
	// Для документа ПоступлениеТоваров требуется 1 партнер.
	...
	// Для документа ПоступлениеТоваров требуется 1 контрагент.
	...
	// Для документа ПоступлениеТоваров требуется 1 договор.

...
// Выполняет проверку заполненности комментария в документе ПоступлениеТоваров.
//
// Параметры:
...
Процедура ПроверитьКомментарийВПоступленииТоваров(Проверка, ПараметрыПроверки) Экспорт
	...
	ОбщийТекстЗапроса = 
	"ВЫБРАТЬ
	|	ПоступлениеТоваров.Ссылка КАК ПроблемныйОбъект,
	...
	ОбщийТекстЗапроса = СтрЗаменить(ОбщийТекстЗапроса, "&Условие", "ПоступлениеТоваров.Комментарий ПОДОБНО """" И &ОграничениеПоДате");
...
Процедура ПриЗаполненииВидовОграниченийПравОбъектовМетаданных(Описание) Экспорт
	...
	// Организации
	Описание = Описание + "
	|Справочник.Организации.Чтение._ДемоОрганизации
	|";
	...
	|Документ.ЗаказПокупателя.Чтение._ДемоОрганизации
	|Документ.ЗаказПокупателя.Чтение._ДемоГруппыПартнеров
	|Документ.ЗаказПокупателя.Изменение._ДемоОрганизации
	|Документ.ЗаказПокупателя.Изменение._ДемоГруппыПартнеров
	...
	|Документ.ПоступлениеТоваров.Чтение._ДемоГруппыПартнеров
	|Документ.ПоступлениеТоваров.Чтение._ДемоМестаХранения
	|Документ.ПоступлениеТоваров.Чтение._ДемоОрганизации
	|Документ.ПоступлениеТоваров.Изменение._ДемоГруппыПартнеров
	|Документ.ПоступлениеТоваров.Изменение._ДемоМестаХранения
	|Документ.ПоступлениеТоваров.Изменение._ДемоОрганизации
	|Документ.РасходныйКассовыйОрдер.Чтение._ДемоОрганизации
	|Документ.РасходныйКассовыйОрдер.Чтение._ДемоКассы
	|Документ.РасходныйКассовыйОрдер.Чтение._ДемоХозяйственныеОперации
	|Документ.РасходныйКассовыйОрдер.Изменение._ДемоОрганизации
	|Документ.РасходныйКассовыйОрдер.Изменение._ДемоКассы
	|Документ.РасходныйКассовыйОрдер.Изменение._ДемоХозяйственныеОперации
	|Документ.РеализацияТоваров.Чтение._ДемоГруппыПартнеров
	|Документ.РеализацияТоваров.Чтение._ДемоМестаХранения
	|Документ.РеализацияТоваров.Чтение._ДемоОрганизации
	|Документ.РеализацияТоваров.Изменение._ДемоГруппыПартнеров
	|Документ.РеализацияТоваров.Изменение._ДемоМестаХранения
	|Документ.РеализацияТоваров.Изменение._ДемоОрганизации
	...
	|Документ.СчетНаОплатуПокупателю.Чтение._ДемоГруппыПартнеров
	|Документ.СчетНаОплатуПокупателю.Чтение._ДемоОрганизации
	|Документ.СчетНаОплатуПокупателю.Изменение._ДемоГруппыПартнеров
	|Документ.СчетНаОплатуПокупателю.Изменение._ДемоОрганизации
